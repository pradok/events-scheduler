...
- [ ] **Task 1: Add ISQSClient Dependency to RecoveryService** (AC: 1)
  - [ ] Open `src/modules/event-scheduling/domain/services/RecoveryService.ts` (created in Story 3.1)
...
- [ ] **Task 4: Write Unit Tests for SQS Integration** (AC: 4)
  - [ ] Open `src/modules/event-scheduling/domain/services/RecoveryService.test.ts` (created in Story 3.1)
...
- [ ] **Task 5: Write Integration Tests for E2E Recovery** (AC: 5)
  - [ ] Create `src/modules/event-scheduling/domain/services/RecoveryService.integration.test.ts`
