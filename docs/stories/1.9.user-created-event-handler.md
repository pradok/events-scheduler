...
- **Location:** `src/modules/event-scheduling/application/event-handlers/`
- **Bounded Context:** Event Scheduling Context
- **Layer:** Application layer (orchestrates domain logic)
- **Dependencies:**
  - Event Scheduling ports (IEventRepository)
  - Event Scheduling domain services (TimezoneService, EventHandlerRegistry)
  - User domain events (UserCreatedEvent)
