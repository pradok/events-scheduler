...
- [ ] **Task 2: Create User with Birthday and Event Scheduled Soon** (AC: 1)
  ...
  - [ ] Use configurable delivery time (Story 2.9b) to schedule event 20-30 seconds from now:
  ...
  - [ ] This approach enables fast E2E test execution without time mocking or creating "overdue" events
  - [ ] Verify user and event exist in database before waiting for event to become ready
  - [ ] Reference: [Source: Story 2.9b - Configurable Event Delivery Times]
  - [ ] Reference: [Source: docs/architecture/data-models.md#User]
  - [ ] Reference: [Source: docs/architecture/data-models.md#Event]

- [ ] **Task 3: Wait for Event to Become Ready** (AC: 2)
  - [ ] **Approach: Real-Time Waiting (Enabled by Story 2.9b)**
  ...
  - [ ] **Alternative (Deprecated):** Old approaches no longer recommended
  ...
  - [ ] Document approach in test comments explaining Story 2.9b integration
  - [ ] Reference: [Source: Story 2.9b - Configurable Event Delivery Times]
  - [ ] Reference: [Source: docs/architecture/test-strategy.md#End-to-End-Tests]
...
- [ ] **Task 6: Wait for Worker Lambda to Process Message** (AC: 5)
  - [ ] **Worker Lambda is auto-triggered by SQS** (deployed via Story 2.9b amendments)
  ...
  - [ ] Wait for worker Lambda to process message (poll for completion):
  ...
  - [ ] Reference: [Source: Story 2.6 - Worker Lambda Integration Tests]
